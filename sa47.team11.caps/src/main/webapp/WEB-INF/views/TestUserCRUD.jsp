...
<a href="${pageContext.request.contextPath}/student/create">Add User</a>
	  ...
	  <tbody>
		 <c:forEach items="${ulist}" var="user" varStatus="index">
			<tr>
		      ...
		      <td><a href="${pageContext.request.contextPath}/user/edit/${user.userid}">Edit User</a></td>
		      <td><a href="${pageContext.request.contextPath}/user/delete/${user.userid}">Delete User</a></td>
		    </tr>
			</c:forEach> 
		</tbody>
	</table>
